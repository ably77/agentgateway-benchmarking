#!/usr/bin/env bash
# Tear down all Scenario 1b resources.
set -euo pipefail
...
read -r -p "This will delete all Scenario 1b resources. Continue? [y/N]: " CONFIRM
...
info "Gateway resources (agentgateway-proxy-mcp, agentgateway-proxy-llm) were left intact."
